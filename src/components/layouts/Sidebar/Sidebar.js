...
//             {/* 1. The Text Link: Navigates to the page */}
//             <Link 
//               url={item.url || "#"} 
//               hoverStyle={hover} 
//               click={toogleSidebar}
...
//             {/* 2. The Arrow Icon: Toggles the submenu independently */}
//             <i
//               className={
//                 submenu === index ? "las la-angle-up" : "las la-angle-down"
//               }
  ...
  return (
    <div className={[styles.wrapper, state.sidebar && styles.show].join(" ")}>
      <div className={styles.sidebar}>
        ...
        <div className={styles.btn_contacts}>
          {/* Button 1: Plan een consult - Navigates to Page */}
          ...
          {/* Button 2: Offerte aanvragen - Opens Modal */}
          <div>
            <Button hoverType="solid-gray-tb" click={toogleModal}>
              Offerte aanvragen
            </Button>
